...
using AzuretriggersFunctions.Models;
using System.Collections.Generic;
using System.Data;
using System.Data.SqlClient;

namespace AzuretriggersFunctions.Functions
{
    public static class TaskListFunction
    {
        [FunctionName("TaskListFunction")]
            ...
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "task")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(Environment.GetEnvironmentVariable("SqlConnectionString")))
                {
                    ...
                    {
                        var query = $"INSERT INTO TaskList (Description,CreatedOn,IsDone) VALUES('{input.Description}', {input.CreatedOn.ToShortDateString()} , '{input.IsDone}')";
